...
namespace Face.Web.Core.FaceAI
{
    ...
    public class FaceSetting
    {
        ...
        public void SetIsCheckQuality(bool flag)
        {
            set_is_check_quality(flag);
        }
        ...
        /// 设置光照阈值，取值范围0~255，默认40，越大代表脸部越亮
        /// </summary>
        /// <param name="throushold"></param>
        public void SetIlluminationThroushold(float throushold)
        {
            set_illum_thr(throushold);
        }
        ...
        public void SetBlurThroushold(float thr)
        {
            set_blur_thr(thr);
        }
        ...
        /// </summary>
        /// <param name="thr"></param>
        public void SetOcculuThr(float thr)
        {
            set_occlu_thr(thr);
        ...
        /// 设置pitch、yaw、roll等角度的阈值，默认都为15&deg;，越大代表可采集的人脸角度越大，但是角度越大识别效果会越差
        /// </summary>
        /// <param name="pitch_thr"></param>
        /// <param name="yaw_thr"></param>
        /// <param name="roll_thr"></param>
        public void SetEulurAngleThr(int pitch_thr,int yaw_thr,int roll_thr)
        {
            set_eulur_angle_thr(pitch_thr, yaw_thr, roll_thr);
        }
        ...
        /// </summary>
        /// <param name="thr"></param>
        public void SetNotFaceThr(float thr)
        {
            set_not_face_thr(thr);
        }
        ...
        /// 但是cpu占用率会提高、处理速度变慢
        /// </summary>
        /// <param name="interval_in_ms"></param>
        public void SetTrackByDetectionInterval(int interval_in_ms)
        {
            set_track_by_detection_interval(interval_in_ms);
        }
        ...
        /// </summary>
        /// <param name="interval_in_ms"></param>
        public void SetDetectInVideoInterval(int interval_in_ms)
        {
            set_detect_in_video_interval(interval_in_ms);
        }
    }
